...
public class TitanicTextView extends TextView {
  ...
  private void init() { shaderMatrix = new Matrix(); }
  ...
  public void
  setAnimationSetupCallback(AnimationSetupCallback animationSetupCallback) {
    this.animationSetupCallback = animationSetupCallback;
  }

  public float getMaskX() { return maskX; }
  ...
  public float getMaskY() { return maskY; }
  ...
  public void setSinking(boolean sinking) { this.sinking = sinking; }
  ...
  private void createShader(Context context) {
    try {
      ...
      try {
        ...
        img = Drawable.createFromStream(context.getAssets().open("rainbow.png"),
                                        null);
