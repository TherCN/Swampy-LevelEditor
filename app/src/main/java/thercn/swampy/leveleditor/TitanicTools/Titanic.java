    ...
    final Runnable animate = new Runnable() {
      ...
      public void run() {
        ...
        ObjectAnimator maskXAnimator =
            ObjectAnimator.ofFloat(textView, "maskX", LEFT, RIGHT);
        maskXAnimator.setRepeatCount(ValueAnimator.INFINITE);
        // maskXAnimator.setDuration(1000);
        maskXAnimator.setDuration(
            setDuration); // So it does not repeat too often. You may need to
                          // increase value above too
        ...
        ObjectAnimator maskYAnimator =
            ObjectAnimator.ofFloat(textView, "maskY", h / 2, -h / 2);
  ...
  public void start(final TitanicButton Button) {
    ...
    final Runnable animate = new Runnable() {
      ...
      public void run() {
        ...
        ObjectAnimator maskXAnimator =
            ObjectAnimator.ofFloat(Button, "maskX", LEFT, RIGHT);
        maskXAnimator.setRepeatCount(ValueAnimator.INFINITE);
        // maskXAnimator.setDuration(1000);
        maskXAnimator.setDuration(
            setDuration); // So it does not repeat too often. You may need to
        ...
        // repeat mode REVERSE to go back and forth
        ObjectAnimator maskYAnimator =
            ObjectAnimator.ofFloat(Button, "maskY", h / 2, -h / 2);
        maskYAnimator.setRepeatCount(ValueAnimator.INFINITE);
        maskYAnimator.setRepeatMode(ValueAnimator.REVERSE);
        maskYAnimator.setDuration(10000);
        maskYAnimator.setStartDelay(0);
