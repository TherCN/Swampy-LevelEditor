...
public class PackageLevelHandler extends SQLiteOpenHelper {
    ...
    private static final String QUERY_LEVEL_TABLE_CREATE = "CREATE TABLE Level (uniqueId INTEGER AUTO_INCREMENT, packageId VARCHAR(30), packageName VARCHAR(30), levelId VARCHAR(30), levelName VARCHAR(30), like_count VARCHAR(30),  user_likes VARCHAR(30) , PRIMARY KEY(levelName, levelId));";
    private static final String QUERY_PACKAGE_LEVEL_TABLE_CREATE = "CREATE TABLE LevelPackage (uniqueId INTEGER AUTO_INCREMENT, packageId VARCHAR(30), packageName VARCHAR(30) , PRIMARY KEY(packageName, packageId));";
    ...
    public LevelModel getLevelObjectWithLevelName(String str, String str2) {
        ...
        synchronized (this) {
            try {
                Cursor query = writableDatabase.query(TABLE_LEVEL, null, "levelName LIKE '%" + str + "%' AND " + kPackageId + " = '" + str2 + "'", null, null, null, null);
                if (query.getCount() > 0) {
                    query.moveToFirst();
                    LevelModel levelModel2 = new LevelModel(query.getString(3), query.getString(1), query.getString(4), query.getString(2), query.getString(5), query.getString(DATABASE_VERSION));
                    try {
                        ...
                        Log.i("DB", "LOAD kUserLikes: " + query.getString(DATABASE_VERSION));
    ...
    public void saveLevelPackages(ArrayList<LevelPackageModel> arrayList, boolean z) {
        ...
        try {
            ...
            for (int i = 0; i < size; i++) {
                ContentValues contentValues = new ContentValues();
                contentValues.put(kPackageId, ((LevelPackageModel) arrayList.get(i)).getPackageId());
                contentValues.put(kPackageName, ((LevelPackageModel) arrayList.get(i)).getPackageName());
                Log.i("DB", "saveLevelPackages: " + i + ". " + ((LevelPackageModel) arrayList.get(i)).getPackageName());
    ...
    public String getLevelIDWithLevelNameAndPackageId(String str, String str2) {
        ...
        synchronized (this) {
            str3 = null;
            try {
                Log.e("", "getLevelID query : levelName LIKE '%" + str + "%' AND " + kPackageId + " = '" + str2 + "'");
                Cursor query = writableDatabase.query(TABLE_LEVEL, null, "levelName LIKE '%" + str + "%' AND " + kPackageId + " = '" + str2 + "'", null, null, null, null);
                if (query.getCount() > 0) {
                    query.moveToFirst();
    ...
    public boolean existLevelIDWithLevelId(String str) {
        ...
        synchronized (this) {
            str2 = null;
            try {
                Cursor query = writableDatabase.query(TABLE_LEVEL, null, "levelId = '" + str + "'", null, null, null, null);
                if (query.getCount() > 0) {
                    query.moveToFirst();
    ...
    public boolean existLevelsWithLevelPackageId(String str) {
        ...
        synchronized (this) {
            str2 = null;
            try {
                Cursor query = writableDatabase.query(TABLE_LEVEL, null, "packageId = '" + str + "'", null, null, null, null);
                if (query.getCount() > 0) {
                    query.moveToFirst();
                    str2 = query.getString(3);
                    Log.i("DB", "levelId: " + str2 + " FOUND!");
    ...
    public String getLevelPackageIDWithIdOrName(String str) {
        ...
        synchronized (this) {
            str2 = null;
            try {
                Cursor query = writableDatabase.query(TABLE_LEVEL_PACKAGE, null, "packageId = '" + str + "' OR " + kPackageName + " = '" + str + "'", null, null, null, null);
                if (query.getCount() > 0) {
                    query.moveToFirst();
    ...
    public void updateLevelWithLevelID(String str, LevelModel levelModel) {
        synchronized (this) {
            try {
                SQLiteDatabase writableDatabase = getWritableDatabase();
                try {
                    String str2 = "UPDATE Level SET like_count = '" + levelModel.getNumberOfLikes() + "', " + kUserLikes + " = '" + levelModel.getUserLikes() + "' WHERE " + kLevelId + " = '" + levelModel.getLevelId() + "'";
    ...
    public void resetUserLikes() {
        synchronized (this) {
            try {
                SQLiteDatabase writableDatabase = getWritableDatabase();
                try {
                    String str = "UPDATE Level SET user_likes = 'false'  WHERE user_likes = 'true'";
    ...
    public void onCreate(SQLiteDatabase sQLiteDatabase) {
        Log.d(getClass().getSimpleName(), "Query: CREATE TABLE LevelPackage (uniqueId INTEGER AUTO_INCREMENT, packageId VARCHAR(30), packageName VARCHAR(30) , PRIMARY KEY(packageName, packageId));");
        sQLiteDatabase.execSQL(QUERY_PACKAGE_LEVEL_TABLE_CREATE);
        Log.d(getClass().getSimpleName(), "Query: CREATE TABLE Level (uniqueId INTEGER AUTO_INCREMENT, packageId VARCHAR(30), packageName VARCHAR(30), levelId VARCHAR(30), levelName VARCHAR(30), like_count VARCHAR(30),  user_likes VARCHAR(30) , PRIMARY KEY(levelName, levelId));");
        sQLiteDatabase.execSQL(QUERY_LEVEL_TABLE_CREATE);
    }
    ...
    public LevelModel getLevelObjectWithLevelId(String str) {
        return null;
    }
}
